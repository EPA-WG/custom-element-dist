import{w as k,e}from"./index-BASH1HpE.js";import"./custom-element--HC2GPP6.js";function a(t){return new Promise(l=>setTimeout(l,t))}function g(t){const{title:l,body:n}=t;return`
        <fieldset>
            <legend>${l}</legend>
            ${n}
        </fieldset>
  `}const Y={title:"slice-events",render:g},s={args:{title:"Slice initialization, change on event",body:`
...
`},play:async({canvasElement:t})=>{const l=o.args.title,n=k(t);await n.findByText(l);const c=()=>n.getByTestId("//slice/s").textContent,i=()=>n.getByTestId("//slice/s/event/@offsetY").textContent,v=()=>n.getByTestId("//slice/s/event/@type").textContent,b=await t.querySelector("textarea");e(c()).to.equal("","initial slot value blank"),e(i()).to.equal("","initial slot offsetY blank"),e(v()).to.equal("","initial slot event blank"),((u,r,q)=>{const T=new MouseEvent(q,{screenX:u,screenY:r,clientX:u,clientY:r,offsetX:u,offsetY:r});b.dispatchEvent(T)})(10,20,"click"),await a(10),e(c()).to.equal("x:10","click slot value 10"),e(Number(i())).to.be.lessThan(0,"offsetY click"),e(v()).to.equal("click","click event type")}};var d,p,m;s.parameters={...s.parameters,docs:{...(d=s.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
...
}`,...(m=(p=s.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};var x,y,f;o.parameters={...o.parameters,docs:{...(x=o.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
...
}`,...(f=(y=o.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};const E=["SliceInitChangeEvent","RealtimeEventInSlice"];export{o as RealtimeEventInSlice,s as SliceInitChangeEvent,E as __namedExportsOrder,Y as default};
