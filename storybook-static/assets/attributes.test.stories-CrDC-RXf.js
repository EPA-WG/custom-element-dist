import{w as c,e as t,u as E}from"./index-CGuyH0k-.js";import{m as g,a as y,c as H}from"./custom-element-wuk8gYiP.js";function x(o){return new Promise(e=>setTimeout(e,o))}function T(o){const{title:e,body:a}=o;return`
        <fieldset>
            <legend>${e}</legend>
            ${a}
        </fieldset>
  `}const I={title:"attributes",render:T,parameters:{test:{dangerouslyIgnoreUnhandledErrors:!0}}};function n(o){const e=document.createElement("div");return e.innerHTML=o,e.firstElementChild}const u={args:{title:"cloneAs(el,newTag)",body:`
