...
**Screen readers** primarily follow HTML semantics and ARIA, not CSS typography. Do not rely on voice tokens to control assistive technology output.
...
This revision replaces the “typography as style” mindset with **typography as semantics**, and introduces **voice** as a cross-modal axis:
...
The result is a token set that stays understandable to consumers of the design system, stable across brand changes, and reusable across visual and vocal presentations.
