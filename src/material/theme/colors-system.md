...
|-------------|----------------|-----------------------------------------------|--------------------------------------------------|-----------------|
| explicit    | creativity     | <div style="background:darkviolet" > ⬤ </div> | <div style="background:VisitedText" > ⬤ </div>  | FF: VisitedText | 
| primary     | trust          | <div style="background:blue"       > ⬤ </div> | <div style="background:LinkText"    > ⬤ </div>  | LinkText        | 
